								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<label class="" for="billing_state"></label>
												<input type="radio" id="method-pagseguro" name="payment-method" placeholder="" 
												value="1" style="float:left; margin: 30px;">
												<label class="" for="method-pagseguro"><img src="/res/site/img/logo-pagseguro.png"
													 style="height: 64px;"></label>
											</p>
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<label class="" for="billing_state"></label>
												...
												<label class="" for="method-paypal"><img src="/res/site/img/logo-paypal.png"
													style="height: 64px;"></label>
											</p>
